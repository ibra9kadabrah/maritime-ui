// src/components/forms/types/berthFormConstants.ts
import type { ProcessedBerthFormData } from './berthFormTypes'; // Import the Zod-inferred type

// --- Options for Select Fields (Copied from noonFormConstants) ---
...
// Note: cargoStatusOptions might not be needed for Berth, but kept here for potential future use or if schema changes.
...
// --- Default Values for Berth Report (Aligned with Zod Schema) ---
...
export const defaultBerthValues: Partial<ProcessedBerthFormData> = {
  // General Info
  date: '',
  timeZone: '',
  berthNumber: '',
  ...
  faspDate: '', // Berth Date
  faspTime: '', // Berth Time
  faspLatitude: undefined, // Berth Latitude
  faspLatitudeDir: 'N',
  faspLongitude: undefined, // Berth Longitude
  faspLongitudeDir: 'E',
  ...
  // Cargo Operations
  cargoUnloadedMT: undefined,
  cargoLoadedMT: undefined,
  loadingStartDate: '',
  loadingStartTime: '',
  loadingEndDate: '',
  loadingEndTime: '',
  ...
  // --- Bunker Section Defaults (Matching Noon) ---
  prsRpm: undefined, // Added
  meLSIFO: undefined, // Added
  meLSMGO: undefined, // Added
  meCYLOIL: undefined, // Added
  meMEOIL: undefined, // Added
  meAEOIL: undefined, // Added
